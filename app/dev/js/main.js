  ...
  if (!is_touch_device() || $(window).width() > 700) {
    ...
    $(window).on("scroll touchmove", function () {
      ...
      if ($(document).scrollTop() > $("#contact").position().top - 500) {
        ...
        if ($("nav ul li a").hasClass("white")) $("nav ul li a").removeClass("white");
        ...
        if ($("nav ul li a").hasClass("black")) $("nav ul li a").removeClass("black");
...
$('.arrow').click(function () {
  $("html").animate({
    scrollTop: $('.wrapper_main').outerHeight()
  }, 1200);
});
